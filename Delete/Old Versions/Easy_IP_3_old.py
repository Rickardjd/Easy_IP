#!/usr/bin/env python3
"""
i-PRO Camera IP Setup Tool
A cross-platform Python alternative to i-PRO's Easy IP Setup Tool.
Discovers and configures network settings for i-PRO IP cameras.
"""
...
class iPROIPSetup:
    """Main class for discovering and configuring i-PRO cameras"""
    ...
    def configure_camera(self, mac_address: str, ip: str, subnet: str, 
        ...
        try:
            ...
            # Fixed sequence matching i-PRO packet
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="i-PRO Camera IP Setup Tool - Discover and configure i-PRO IP cameras",
...
Examples:
  ...
  %(prog)s discover --json | jq .
    ...
    if args.command == 'diag':
        ...
        setup = i-PROIPSetup(timeout=args.timeout, verbose=args.verbose)
